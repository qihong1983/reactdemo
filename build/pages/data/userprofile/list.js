...
class userProfile extends React.Component {
	...
	render() {
      ...
      <a href="#" className="ant-dropdown-link">
		...
		var list = this.props.userProfile.List.list;
		...
		return (
			<div>
        <Content style={{ background: '#fff', padding: 24, margin: 0, minHeight:'600px'}}>
          <Form layout="inline">
          	<FormItem label="操作系统">
          		<Select 
        ...
        <Content style={{ background: '#fff', padding: "24px", margin: 24, marginTop:"24px", minHeight: 280 }}>
          <Table dataSource={this.props.userProfile.List.list} columns={columns} />
        </Content>
        </div>
		);
	}
